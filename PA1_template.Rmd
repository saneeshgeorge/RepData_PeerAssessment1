...
```
The mean of total number of steps per day is `r stepsMean`.  
The median of total number of steps per day is `r stepsMedian`.
...
```
The Interval which contains the maximum number of steps on average is `r maxAvg`.
...
```
The mean of total number of steps per day is `r stepsCompMean`.  
The median of total number of steps per day is `r stepsCompMedian`.
